                  ...
                  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                     <div class="menu_section">
                        <ul class="nav side-menu">
                           ...
                           <li><a href="<?= base_url(); ?>admin/industry"><i class="fa fa-industry"></i> <span>Industries</span></a></li>
                           <li><a href="<?= base_url(); ?>admin/packages"><i class="fa fa-cubes"></i> <span>Packages</span></a></li>
                           <li>
                              <a><i class="fa fa-edit"></i>Themes <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                                 <li><a href="<?= base_url(); ?>admin/category">Theme Category</a></li>
                                 <li><a href="<?= base_url(); ?>admin/themes">Themes</a></li>
                              </ul>
                           </li>
                           <li><a href="<?= base_url(); ?>admin/webapp"><i class="fa fa-mobile"></i> <span>WebApp</span></a></li>
                           <li><a href="<?= base_url(); ?>admin/payments"><i class="fa fa-credit-card"></i> <span>Payment</span></a></li>
                        </ul>
                     </div>
                  </div>
                  <!-- /sidebar menu -->
