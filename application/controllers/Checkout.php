<?php
	...
	class Checkout extends MY_Controller {
		...
		public function checkoutsubmit()
		{
			...
			$paymentarr=array('user_id'=>$userid,'webapp_id'=>$webid,'amount_paid'=>$amount,'status'=>$status,'payment_date'=>DateTime_Now,'gateway'=>'stripe','gateway_returns'=>$cookiearr[11]);
