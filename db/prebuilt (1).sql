...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2018 at 07:28 AM
...
INSERT INTO `pre_categories` (`id`, `name`, `desc`, `tag`, `parent_id`, `image`, `date_created`, `date_modified`, `status`) VALUES
(1, 'CMS', NULL, 'cms', 0, NULL, '2018-11-19', NULL, 1),
(2, 'e-commmerce', NULL, NULL, 0, NULL, '2018-11-19', NULL, 1),
(3, 'HTML &amp; CSS', NULL, NULL, 0, NULL, '2018-11-19', NULL, 1),
(4, 'WordPress', NULL, NULL, 1, NULL, '2018-11-19', NULL, 1),
(5, 'WooCommerce', NULL, NULL, 2, NULL, '2018-11-19', NULL, 1),
(6, 'Online Store', NULL, NULL, 3, NULL, '2018-11-19', NULL, 1),
(7, 'Portfolio', NULL, NULL, 3, NULL, '2018-11-19', NULL, 1),
(8, 'Bloging', NULL, NULL, 1, NULL, '2018-11-19', NULL, 1);
...
DROP TABLE IF EXISTS `pre_cities`;
...
DROP TABLE IF EXISTS `pre_countries`;
...
DROP TABLE IF EXISTS `pre_industries`;
...
DROP TABLE IF EXISTS `pre_packages`;
...
INSERT INTO `pre_packages` (`package_id`, `name`, `package_details`, `package_price`, `package_discount`, `package_type`, `date_created`, `date_modified`, `status`) VALUES
(1, 'Standard', '<li>Website designed by professionals</li>\r\n                           <li>Free Website Domain(First Year)</li>\r\n                           <li>Unlimited Revisions</li>\r\n                           <li>Reliable Hosting</li>\r\n                           <li>PayPal Integeration</li>\r\n                           <li>Add up to 7 additional pages</li>\r\n                           <li>Up to 10 pictures</li>\r\n                           <li>Extremely Fast Turnaround</li>', 249, 0, 0, '2018-12-12', '2018-12-19', 1);
...
DROP TABLE IF EXISTS `pre_settings`;
...
DROP TABLE IF EXISTS `pre_themes`;
...
DROP TABLE IF EXISTS `pre_theme_to_category`;
...
INSERT INTO `pre_users` (`user_id`, `user_role`, `user_name`, `password`, `email`, `date_created`, `date_modified`, `status`, `reset_token`) VALUES
(1, 0, 'dsadad', NULL, '', '2018-12-04', NULL, 0, ''),
(2, 0, 'dsadad', NULL, '', '2018-12-04', NULL, 0, ''),
(3, 0, 'ada', NULL, '', '2018-12-04', NULL, 0, '');
...
DROP TABLE IF EXISTS `pre_user_details`;
...
--
-- Table structure for table `pre_user_role`
--
...
--
-- Dumping data for table `pre_user_role`
--

INSERT INTO `pre_user_role` (`id`, `name`, `created_at`, `updated_at`) VALUES
(1, 'admin', '2018-12-01 11:00:45', '2018-12-01 11:00:45'),
(2, 'subscriber', '2018-12-01 11:00:48', '2018-12-01 11:00:48'),
(3, 'contributor', '2018-12-01 11:01:18', '2018-12-01 11:01:18');
...
DROP TABLE IF EXISTS `pre_webapp`;
CREATE TABLE `pre_webapp` (
  ...
  `have_domain` int(1) NOT NULL DEFAULT '0' COMMENT '0= No , 1 = Yes',
  `domain` varchar(100) DEFAULT NULL,
  `theme_id` int(7) DEFAULT '0',
  `customization_details` text COMMENT 'Customizations requested by user at the time of order',
  `package_id` int(2) DEFAULT '0',
  `contact_preference` int(1) NOT NULL DEFAULT '0' COMMENT '0 = Email, 1 = Phone',
...
--
-- Indexes for table `pre_user_role`
--
ALTER TABLE `pre_user_role`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `pre_packages`
  MODIFY `package_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `pre_user_role`
--
ALTER TABLE `pre_user_role`
